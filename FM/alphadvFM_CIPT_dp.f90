...
!	call MNparm(7,'atau',0.34082180944017310d0,0.1d0,0.0d0,0.0d0,perr)
	...
	call MNparm(1,'alpha',3.55d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(2,'beta',0.45d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(3,'gamma',2.07d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(4,'delta',2.00d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(5,'atau',0.37d0,0.1d-4,0.0d0,0.0d0,perr)
