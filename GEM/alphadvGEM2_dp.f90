PROGRAM main
	...
	integer			:: n,m, statenull, nbin, NPARI, NPARX, istat  ! used in loops
	
	real (kind=dp)	:: alpha,beta,gamma,delta,beta1,delta1  ! parameters
	...
	call MNparm(1,'alpha',3.47d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(2,'beta',0.60d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(3,'gamma',-3.37d-2,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(4,'delta',3.08d0,0.1d-4,0.0d0,0.0d0,perr)
...
!	call MNparm(8,'beta1',0.63d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(5,'beta1',11.08d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(6,'delta1',12.74d0,0.1d-4,0.0d0,0.0d0,perr)
...
!	call MNparm(12,'zeta1',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(7,'atau',0.33d0,0.1d-4,0.0d0,0.0d0,perr)
...
!	call MNparm(1,'alpha0',3.53d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(2,'beta0',0.61d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(3,'gamma0',-2.47d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(4,'delta0',4.34d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(5,'eta0',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(6,'zeta0',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(7,'alpha1',3.48d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(8,'beta1',0.63d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(5,'gamma1',-30d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(6,'delta1',17.8d0,0.1d-4,0.0d0,0.0d0,perr)
!	!call MNparm(6,'gamma1',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(11,'eta1',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(12,'zeta1',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(7,'atau',0.295d0,0.1d-4,0.0d0,0.0d0,perr)
!	call mnexcm(fcn,'SET PRINTout', (/1.0_dp/),1,perr,0)  ! set print level (2=full)
...
!	call MNparm(7,'alpha1',3.48d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(8,'beta1',0.63d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(5,'beta1',pval(5),0.1d-4,0.0d0,0.0d0,perr)
...
!	call MNparm(1,'alpha',3.0d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(2,'beta',0.5d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(3,'gamma',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(4,'delta',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(5,'eta0',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(6,'zeta0',1.0d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(7,'alpha1',3.48d0,0.1d-4,0.0d0,0.0d0,perr)
!!	call MNparm(8,'beta1',0.63d0,0.1d-4,0.0d0,0.0d0,perr)
!	call MNparm(5,'beta1',0.0d0,0.1d-4,0.0d0,0.0d0,perr)
...
!	call MNparm(7,'atau',0.34d0,0.1d-4,0.0d0,0.0d0,perr)
	...
	arg(2) = 6.0_dp
	arg(3) = 3.0_dp
	call mnexcm(fcn, 'Set LIMits', (/ 6._dp, 0.0d0, 100.0d0 /), 3, perr, 0)
	!call mnexcm(fcn, 'Set LIMits', (/ 2._dp, 0.0d0, 10d0 /), 3, perr, 0)
	!call mnexcm(fcn,'FIX', (/5.0_dp,6._dp,7.0_dp,12._dp,13._dp/),3, perr, 0)   
...
!	call MNparm(6,'delta1',4._dp*pval(4),ierr(4),0.0d0,0.0d0,perr)
	!call mnexcm(fcn, 'SET STRategy', (/ 2._dp /), 1, perr, 0)
	!call mnexcm(fcn,'RELeas', (/7.0_dp,6.0_dp,2._dp/), 1, perr, 0)
	!call mnexcm(fcn, 'HESse', (/ 2._dp /), 0, perr, 0)
	!call mnexcm(fcn,'SIMplex',    (/10000.0_dp,0.1_dp/),2,perr,0)  ! perform MIGRAD minimization
	!call mnexcm(fcn,'MINimize',    (/10000.0_dp,0.001_dp/),2,perr,0)  ! perform MIGRAD minimization
	...
	!call mnexcm(fcn, 'HESse', (/ 2._dp /), 0, perr, 0)
	!call MNparm(5,'beta1',3.0d0,0.1d-4,0.0d0,0.0d0,perr)
	!if (nbin>51) call MNparm(6,'delta1',2.0d0,0.1d-4,0.0d0,0.0d0,perr)
	!call mnexcm(fcn, 'Set LIMits', (/ 6._dp, 0.0d0, 100.0d0 /), 3, perr, 0)
	!call mnexcm(fcn,'RELeas', (/5.0_dp,6.0_dp,2._dp/), 2, perr, 0)
	!call mnexcm(fcn, 'HESse', (/ 2._dp /), 0, perr, 0)
	!call mnexcm(fcn,'SIMplex',    (/10000.0_dp,0.1_dp/),2,perr,0)  ! perform MIGRAD minimization
	!call mnexcm(fcn,'MIN',    (/10000.0_dp,0.1d0/),2,perr,0)  ! perform MIGRAD minimization	
...
!	call mnexcm(fcn, 'HESse', (/ 2._dp /), 0, perr, 0)
	...
	!write(*,*) ni_DVV(52, pval(1),pval(2),pval(3),pval(4),pval(5),pval(6))
	
	!write(*,*) DGAMIC(-1.0d0,1.55d0)
...
!write(*,*) truecovv(58,58)
	...
	write(*,*) 'CORRECTION TO FM = ', pval(6) / ((sbin(binmin)+0.5d0*dsbin(binmin))**pval(6))
...
!		/ (cosh(gammaV * s**rhoV) - cos(alphaV * s**rhoV + betaV)) )
		...
		!f_DVV =	exp(-alpha - beta * s) * sin(gamma + delta * s) * (1._dp + beta1/(s**delta1)) 
		f_DVV =	exp(-alpha - beta * s) * sin(gamma + delta * s) * beta1 / (s**delta1)
...
!		/ (cosh(gammaV * s**rhoV) - cos(alphaV * s**rhoV + betaV)) )
		...
		!f_DVV =	exp(-alpha - beta * s) * sin(gamma + delta * s) * (1._dp + beta1/(s**delta1)) 
		f_DV =	exp(-alpha - beta * s) * sin(gamma + delta * s) * ( 1.0d0 + beta1 / (s**delta1) )
	...
	!
		...
		real (kind=dp) :: ni_DVV, s, fabserr, ni_tmp
		...
		ni_tmp = exp(-a-b*s)*(d*cos(c+d*s)+b*sin(c+d*s))/(b**2+d**2)
		...
		call dqagi(f_DVV,s,1,1.0d-18,1.0d-40,ni_DVV,fabserr,fneval, &
	...
	!
		...
		real (kind=dp) :: bb
		integer     :: fier, fneval, flast, flenw
		real (kind=dp) :: ni_DV, s, fabserr, ni_tmp
		real (kind=dp) :: fwork(400)
		integer, dimension(200) :: fiwork		
...
!		s = sbin(bin) + dsbin(bin) / 2.0_dp
	...
	SUBROUTINE PltData(pnts, a, b)
		...
		!
		!	th Data file -> [1:s, 2:specOPE, 3:specDV, 4:specALL, 5:FESR] >> data/PltDataThGEM2.dat
		!
		!	ex Data file -> [1:s, 2:spec, 3:err_spec, 4:FESR, 5:err_FESR] >> data/PltDataExGEM2.dat
		!
		...
		open(55, file='data/PltDataThGEM2.dat')
		...
		close(55)
		open(55, file='data/PltDataExGEM2.dat')
