PROGRAM main
	...
	call MNparm(1,'alphaV',4.19d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(2,'betaV',1.9d-4,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(3,'gammaV',4.8d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(4,'deltaV',0.11d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(5,'rhoV',9.3d0,0.1d-4,0.0d0,0.0d0,perr)
	call MNparm(6,'sigmaV',3.7d0,0.1d-4,0.0d0,0.0d0,perr)
